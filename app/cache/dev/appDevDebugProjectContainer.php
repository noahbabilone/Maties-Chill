...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'mc_allo_data' => 'getMcAlloDataService',
            'mc_allo_helper' => 'getMcAlloHelperService',
            'mc_allo_image' => 'getMcAlloImageService',
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MCBundle', ($this->targetDirs[2].'/Resources/MCBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'MCBundle', ($this->targetDirs[3].'/src/MCBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'matieschill', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/MCBundle/Entity'))), 'MCBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('MCBundle' => 'MCBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b8a8281aed97fc17fd9fb06ae56b3a6eafdcfce54702ddca50eb91bd9f2fb436');
    ...
    /**
     * Gets the 'mc_allo_data' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MCBundle\Service\AlloData A MCBundle\Service\AlloData instance.
     */
    protected function getMcAlloDataService()
    {
        return $this->services['mc_allo_data'] = new \MCBundle\Service\AlloData();
    }

    /**
     * Gets the 'mc_allo_helper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MCBundle\Service\AlloHelper A MCBundle\Service\AlloHelper instance.
     */
    protected function getMcAlloHelperService()
    {
        return $this->services['mc_allo_helper'] = new \MCBundle\Service\AlloHelper('ALLO_THROW_EXCEPTIONS', '29d185d98c984a359e6e6f26a0474269', true, true, 100043982026, 'api.allocine.fr', 'images.allocine.fr');
    }

    /**
     * Gets the 'mc_allo_image' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \MCBundle\Service\AlloImage A MCBundle\Service\AlloImage instance.
     */
    protected function getMcAlloImageService()
    {
        return $this->services['mc_allo_image'] = new \MCBundle\Service\AlloImage();
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'MCBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/MCBundle/Resources/views'), 'MC');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2e6a40401e282da215e2f242a6f0224bc314c6dc');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56bcb93e1389c2.00770575')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '2e6a40401e282da215e2f242a6f0224bc314c6dc',
            'allo_throw_exceptions' => 'ALLO_THROW_EXCEPTIONS',
            ...
            'kernel.secret' => '2e6a40401e282da215e2f242a6f0224bc314c6dc',
